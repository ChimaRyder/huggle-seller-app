...
import { addressInfoSchema } from '../validationSchemas';

const provinces = [
  "Ilocos Norte", "Ilocos Sur", "La Union", "Pangasinan", "Batanes", "Cagayan", "Isabela", "Nueva Vizcaya", "Quirino",
  ...
  "Aklan", "Antique", "Capiz", "Iloilo", "Negros Occidental", "Guimaras", "Bohol", "Cebu", "Negros Oriental", "Siquijor",
  "Eastern Samar", "Leyte", "Northern Samar", "Samar (Western Samar)", "Southern Leyte", "Biliran",
  "Zamboanga Del Norte", "Zamboanga Del Sur", "Zamboanga Sibugay", "City Of Isabela",
  "Bukidnon", "Camiguin", "Lanao Del Norte", "Misamis Occidental", "Misamis Oriental",
  "Davao Del Norte", "Davao Del Sur", "Davao Oriental", "Compostela Valley", "Davao Occidental",
  "Cotabato (North Cotabato)", "South Cotabato", "Sultan Kudarat", "Sarangani", "Cotabato City",
  "Ncr, City Of Manila, First District", "City Of Manila", "Ncr, Second District", "Ncr, Third District", "Ncr, Fourth District",
      ...
      {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldValue }) => (
        ...
        >
          <Input
            ...
            caption={touched.registeredAddress && errors.registeredAddress ? errors.registeredAddress : 'Please enter your complete street address including building/unit number'}
            status={touched.registeredAddress && errors.registeredAddress ? 'danger' : 'basic'}
            style={styles.input}
            multiline={true}
